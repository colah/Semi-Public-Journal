...
+ A lot of people I deeply respect are polyamorous.
  ...
  + LN- observed "most people don't want to be monogamous, they want their partner to be monogamous." I don't think that's true in my case. I'm less uncomfortable with the idea of only having one partner and them having multiple partners to full polyamory. (Though I'd also greatly prefer for my partner to not have other partners.)
    ...
    + D- thinks this puts me, while superficially in an extremely different group that people in polyamory, in some deep sense in a very similar group. In particular, there's a similar line of thinking that goes "I care about my partner's happiness more than mine and chose (without any expectation of reciprocation) to not constrain my partner's actions in any way." This is then usually reciprocated, and can lead to a relationship that is formally not monogamous (even if it is in practice).
   + The form of polyamory I am have observed that I am least uncomfortable with is SDCJL where it is a fully-connected graph.
   + I think what this drives at is that the thing that matters most deeply to me is something like the depth of my relationship with my partner and the closeness of it.
